...
// MARK: - Color.Shades (Legacy)

@available(*, deprecated, message: "Use UIColor.Shades instead. The SwiftUI palette is superseded by the UIKit design system and will be removed.")
extension Color {
